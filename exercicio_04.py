...
if os.path.exists(user_file): #Se o arquivo existir...
    ...
    with open(user_file, 'r') as file_read, open('Python_08.codons-6frames.nt', 'w') as file_write: #Abrindo o arquivo inserido pelo usuário.
        ...
        for key, value in dictionary.items():
            try:
                ...
                file_write.write('>' + key + '-frame-1-rc-codon\n')
                file_write.write(value['ORF1_rc'] + '\n')
                file_write.write('>' + key + '-frame-2-codon\n')
                file_write.write(value['ORF2'] + '\n')
                file_write.write('>' + key + '-frame-2-rc-codon\n')
                file_write.write(value['ORF2_rc'] + '\n')
                file_write.write('>' + key + '-frame-3-codon\n')
                file_write.write(value['ORF3'] + '\n')
                file_write.write('>' + key + '-frame-3-rc-codon\n')
                file_write.write(value['ORF3_rc'] + '\n')
            except:
                KeyError
        print('Arquivo \'Python_08.codons-6frames.nt\' foi gerado.') #Aviso para o usuário do arquivo que acabou de ser gerado.
